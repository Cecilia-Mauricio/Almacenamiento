...
void loop()
{
  ...
  { //Check WiFi connection status
    ...
    HTTPClient http;                                                                                  
    http.begin("http://192.168.43.90:3300/interruptores/5fa0aaff8508b2199b1ccf35");
...
interruptor = "int1";
est = "izquierdo"; 
post("5fa0aaff8508b2199b1ccf35", interruptor, est);
}
}
else if (vel==HIGH){
  b=b+1;
...
void post(String id, String interruptor, String est) {
  ...
  HTTPClient http;
  String json;
  server = "http://192.168.43.90:3300/interruptores/5fa0aaff8508b2199b1ccf35";
